...
class Upcoming extends Component {
  state = {fetchstatus: status.loading, upcomingmoviedetails: []}
  componentDidMount() {
  ...
  getupcomingmoviedetails = async () => {
    ...
    this.setState({
      upcomingmoviedetails: converteddata,
  ...
  returnmovie = () => {
    const {upcomingmoviedetails} = this.state
    return (
      <ul className="movieContainer">
        {upcomingmoviedetails.map(eachitem => (
